...
-- Estructura basada en los modelos JSON `Lote` y `Subasta` documentados en ../../../../../README.md (ms-catalogo).
-- Copia de db/schema_catalogo/V1__init.sql — ver db/README.md, sección "Migraciones automáticas".
