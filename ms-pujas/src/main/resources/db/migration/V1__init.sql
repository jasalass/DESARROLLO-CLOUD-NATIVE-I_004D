...
-- Estructura basada en el modelo JSON `Puja` documentado en ../../../../../../README.md (raíz del proyecto).
-- Copia de db/schema_pujas/V1__init.sql — ver db/README.md, sección "Migraciones automáticas (Flyway)".
